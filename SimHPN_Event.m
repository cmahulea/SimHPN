...
function dm = SimHPN_Event(t, m, options, Pre, Post, C, lambda, seman, eabs, tf)
...
if ((isempty(h_handle)) && (t < tf))
    ...
    h_handle = waitbar(0,'Please wait...','Name','SimHPN Toolbox','CreateCancelBtn','SimHPN_Event(''back'')',...
        'CloseRequestFcn','SimHPN_Event(''back'')');
