...
function Sub_sys = subSysPartition(Pre, Post, m0, mf, lambda, partitions)
...
for i = 1 : num_sub
    ...
    [Sub_sys{i}.p, Sub_sys{i}.t] = divideNet(Pre, Post, partitions{i}.b, partitions{i}.it);

    Sub_sys{i}.it = partitions{i}.it; 
    Sub_sys{i}.b = partitions{i}.b;
    Sub_sys{i}.w = [];
