...
function [sigmaV, m_steady, flow_steady] = optCtl(Pre, Post, lambda, m0, tIdxToMax, wip)
...
% constrain 3: \phi_i = \lambda_i * (m_j / Pre(p_j, t_i) - v(p_j, t_i)
